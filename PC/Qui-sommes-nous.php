  ...
  <body>
    ...
    <section id="Corps">
      ...
      <article id="Introduction">
        ...
        <p>Nous sommes trois étudiants issus de l’IAE d’Orléans qui au travers d’un concours, on crée une solution innovante et pratique.</p>
        <p>Médilib est une plateforme qui pourra changer votre manière de prendre un RDV plus efficace avec des thérapeutes certifiés et gratuit.</p>
        <p>La modélisation du projet est dans la connaissance des secteurs de la médecine douce.</p>
        <p>Amandine a de nombreuses expériences dans le domaine de la phytothérapie puisqu’elle possède une certification de conseillère aroma-phytothérapie.</p>
        <p>Héloïse a déjà rencontré les problème de prise de RDV auprès de thérapeutes, elle souhaitent mettre à profit ces compétences marketing afin que tout le monde puissent accéder à la médecine douce en mettant en valeur les aspects de notre plateforme.</p>
        <p>Miloud est lui manager et auditeur qualité de profession. Il sait que la qualité est un gage de satisfaction, il est donc engagé dans l’amélioration continue de notre plateforme. de prise de RDV.</a>
      </article>
